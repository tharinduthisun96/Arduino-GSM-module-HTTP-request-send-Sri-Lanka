...
void setup()
{
 ...
 myGsm.println("AT+SAPBR=3,1,\"APN\",\"www.dialogwap.com\"");//setting the APN,2nd parameter empty works for all networks 
 delay(5000);
 printSerialData();
 ...
 myGsm.println("AT+HTTPPARA=\"URL\",\"http://jsonplaceholder.typicode.com/todos/1\"");// setting the httppara, 
